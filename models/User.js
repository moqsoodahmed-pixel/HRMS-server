...
const userSchema = new mongoose_1.Schema({
    ...
    // Set only when an HR/CTO/PROJECT_HEAD/FOUNDER_CEO-tier admin manually
    // locks or unlocks this account (see controllers/accountAccessController.js)
    // — never written by the automatic 5-failed-attempts lockout in
    // authController.login(), so the "Locked Accounts" admin panel can tell
    // "system locked this after failed attempts" apart from "someone with
    // permission deliberately locked this account" and show who/why.
