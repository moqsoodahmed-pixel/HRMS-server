...
ROLE_DUTIES = {
    ...
    'Project Head': [
        ...
        'Maintaining project documentation, budgets, change logs and post-project reviews.',
        'Performing other reasonable duties and responsibilities assigned by the Company from time to time.',
    ],
    'CTO': [
        'Defining and driving the Company\u2019s technology vision, architecture strategy and engineering roadmap.',
        ...
        'Ensuring security, data protection and compliance across all technical systems.',
        'Representing the Company in technical discussions with clients, investors and partners.',
        'Performing other reasonable duties and responsibilities assigned by the Company from time to time.',
    ],
    'Developer': [
        'Designing, developing and maintaining software applications in accordance with technical specifications.',
        'Writing clean, efficient, well-documented and testable code following Company engineering standards.',
        'Participating in code reviews, technical discussions and sprint planning sessions.',
        'Collaborating with product managers, designers and QA to deliver high-quality features on schedule.',
        'Debugging, troubleshooting and resolving software defects and performance issues.',
        'Contributing to technical documentation, API references and system architecture notes.',
        'Integrating third-party services, APIs and libraries as required.',
        'Participating in deployment, monitoring and incident response activities.',
        'Continuously upgrading technical skills and staying current with relevant technologies.',
        'Performing other reasonable duties and responsibilities assigned by the Company from time to time.',
    ],
    'Full Stack Trainee': [
        'Assisting in the development of frontend and backend features under the guidance of senior developers.',
        'Learning and applying best practices in web development, code structure and version control.',
        'Participating in code reviews, daily stand-ups and sprint activities.',
        'Working on assigned tasks and bug fixes across the application stack.',
        'Writing and maintaining unit tests and documentation for developed components.',
        'Collaborating with team members to understand project requirements and deliver solutions.',
        'Continuously upgrading technical knowledge through self-learning and training.',
        'Performing other reasonable duties and responsibilities assigned by the Company from time to time.',
    ],
    'Backend Trainee': [
        'Assisting in the development and maintenance of backend services, APIs and databases.',
        'Learning server-side programming, RESTful API design and database management under mentorship.',
        'Participating in code reviews and technical discussions with the engineering team.',
        'Writing clean, documented code and unit tests for assigned backend modules.',
        'Debugging and resolving backend issues as directed by senior engineers.',
        'Contributing to technical documentation and internal knowledge bases.',
        'Performing other reasonable duties and responsibilities assigned by the Company from time to time.',
    ],
    'Admin Manager': [
        'Overseeing day-to-day administrative operations and ensuring smooth office functioning.',
        'Managing office supplies, vendor relationships, facilities and administrative budgets.',
        'Coordinating travel, accommodation and logistics for Company personnel.',
        'Maintaining Company records, contracts, documentation and filing systems.',
        'Supporting HR and finance teams with administrative and compliance activities.',
        'Managing front-office operations, reception and visitor management.',
        'Coordinating internal events, meetings and team activities.',
        'Implementing and improving administrative processes and policies.',
        'Ensuring adherence to Company administrative policies and regulatory requirements.',
        'Performing other reasonable duties and responsibilities assigned by the Company from time to time.',
    ],
    'COO': [
        'Overseeing day-to-day business operations across all departments and functions.',
        'Translating the Company\u2019s strategic vision into operational plans and execution roadmaps.',
    ...
    'Director': [
        'Providing strategic leadership and direction for the assigned function or business unit.',
        'Setting departmental goals, KPIs and performance benchmarks aligned with Company objectives.',
        'Leading, mentoring and developing senior team members within the function.',
        'Collaborating with the leadership team on company-wide strategy, planning and execution.',
        'Managing key stakeholder relationships including clients, partners, investors and regulators.',
        'Overseeing budgets, resource allocation and operational plans for the function.',
        'Driving innovation, growth and continuous improvement within the assigned domain.',
        'Representing the Company externally in industry forums, events and strategic discussions.',
        'Ensuring compliance with applicable laws, regulations and Company policies.',
        'Performing other reasonable duties and responsibilities assigned by the Company from time to time.',
    ],
    'Founder & CEO': [
        'Setting the overall vision, mission and strategic direction of the Company.',
        'Leading and inspiring all teams to execute on Company goals and deliver results.',
        'Building and managing relationships with investors, clients, partners and key stakeholders.',
        'Overseeing all business functions including product, technology, sales, HR and finance.',
        'Making key decisions on company strategy, product direction, hiring and resource allocation.',
        'Representing the Company in public forums, media, industry events and investor meetings.',
        'Driving fundraising, business development and partnership initiatives.',
        'Ensuring corporate governance, compliance and ethical standards across the organisation.',
        'Fostering a high-performance, innovation-driven and inclusive company culture.',
